    ...
    public static class Dbinitializer
    {
        ...
        private static async Task SeedCases(ApplicationDbContext context, UserManager<IdentityUser> userManager)
        {
            if (!context.Case.Any())
            {
                ...
                Case testCase1 = new Case { Title = "Test Case 1", Details = "Case Details", WorkerID = worker1.Id, WorkerEmail = worker1.Email, ReviewerID = reviewer1.Id, ReviewerEmail = reviewer1.Email, ApproverID = approver1.Id, ApproverEmail = approver1.Email, DateCreated = new DateTime(2018, 08, 20), DateReviewed = null, DateApproved = null, Status = CaseStatus.Pending };
                Case testCase2 = new Case { Title = "Test Case 2", Details = "Case Details", WorkerID = worker3.Id, WorkerEmail = worker3.Email, ReviewerID = reviewer1.Id, ReviewerEmail = reviewer1.Email, ApproverID = approver3.Id, ApproverEmail = approver3.Email, DateCreated = new DateTime(2018, 08, 22), DateReviewed = null, DateApproved = null, Status = CaseStatus.PendingReview };
                Case testCase3 = new Case { Title = "Test Case 3", Details = "Case Details", WorkerID = worker2.Id, WorkerEmail = worker2.Email, ReviewerID = reviewer2.Id, ReviewerEmail = reviewer2.Email, ApproverID = approver2.Id, ApproverEmail = approver2.Email, DateCreated = new DateTime(2018, 08, 18), DateReviewed = new DateTime(2018, 08, 22), DateApproved = null, Status = CaseStatus.PendingApproval };
                Case testCase4 = new Case { Title = "Test Case 4", Details = "Case Details", WorkerID = worker2.Id, WorkerEmail = worker2.Email, ReviewerID = reviewer3.Id, ReviewerEmail = reviewer3.Email, ApproverID = approver3.Id, ApproverEmail = approver3.Email, DateCreated = new DateTime(2018, 08, 20), DateReviewed = new DateTime(2018, 08, 27), DateApproved = null, Status = CaseStatus.PendingApproval };
                Case testCase5 = new Case { Title = "Test Case 5", Details = "Case Details", WorkerID = worker1.Id, WorkerEmail = worker1.Email, ReviewerID = reviewer3.Id, ReviewerEmail = reviewer3.Email, ApproverID = approver2.Id, ApproverEmail = approver2.Email, DateCreated = new DateTime(2018, 08, 20), DateReviewed = new DateTime(2018, 08, 24), DateApproved = new DateTime(2018, 08, 25), Status = CaseStatus.Approved };
                Case testCase6 = new Case { Title = "Test Case 6", Details = "Case Details", WorkerID = worker3.Id, WorkerEmail = worker3.Email, ReviewerID = reviewer1.Id, ReviewerEmail = reviewer1.Email, ApproverID = approver1.Id, ApproverEmail = approver1.Email, DateCreated = new DateTime(2018, 08, 21), DateReviewed = new DateTime(2018, 08, 22), DateApproved = new DateTime(2018, 08, 22), Status = CaseStatus.Approved };
